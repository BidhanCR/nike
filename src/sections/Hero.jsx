    ...
    return (
        <section id="Home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[75px] max-sm:leading-[82px] font-bold">
                ...
                <div className="flex justify-starts items-center flex-wrap w-full mt-20 gap-16 ">
                    {statistics.map((stat) => (
                        <div key={stat.label}>
            ...
            <div className="flex-1 relative flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
                <img src={bigShoeImage} alt="show collection" width={610} height={500} className="object-contain relative z-10" />
